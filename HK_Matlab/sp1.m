...
disp('y1: triangle pulse with width of 2')
disp('y2: triangle  pulse with width of 2')
y1 = rectpuls(t,1);
y2 = tripuls(t,0.5,-1);
subplot(4,2,1);plot(t,y1,'Color','blue'),axis(ax); 
grid on;
xlabel('t')
ylabel('y1')

subplot(4,2,2);plot(t,y2,'Color','red'),axis(ax); 
%grid on;
xlabel('t')
ylabel('y2')
...
for i = 1:iter 
 ...
 %   y2_shifted = rectpuls(t-moveStep,1);
    y2_shifted = sin(t);
